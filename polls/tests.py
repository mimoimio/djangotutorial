...
def create_question(question_text,days):
    ...
    (negative for questions published in the passt, positive for questions that have yet to be published)
    """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_two_past_questions(self):
        ...
        question2 = create_question(question_text="Pass question 2.", days=-5)
        response = self.client.get(reverse("polls:index"))
        self.assertQuerySetEqual(
            response.context["latest_question_list"],
            [question2, question1],
...
class QuestionDetailViewTeests(TestCase):
    def test_future_question(self):
        """
    ...
    def test_past_question(self):
        """
        The detail view of a questoin with a pub_date in the past displays the question's text.
        """
